...
<form id="formNouveauCompte" action="Compte" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="form-group col-md-8" id="pseudoDiv">
            ...
            <div class="alert alert-danger" id="compteKO" role="alert">
                <span class="glyphicon glyphicon-ban-circle"></span> Le pseudo que vous avez choisi existe déjà !
            </div>
        </div>
        ...
        <div class="form-group col-md-8">
            ...
            <select class="form-control" id="inputEcole" type="text" name="ecole" requierd>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            <input type="checkbox" id="checkConditions" name="termesEtConditions" value="this.checked;"/> J'accepte les <a href="#" data-toggle="modal" data-target="#modalTermesConditions">Termes et Conditions</a> d'utilisation
            ...
            <div class="modal fade" id="modalTermesConditions" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content" >
                        ...
                        <button class="btn btn-success right" type="button" id="acceptConditionBoutton">J'accepte</button>
                        <button class="btn btn-danger left" type="button" id="doesntAcceptConditionBoutton">Je n'accepte pas</button>
                    </div>
                </div>
            </div>
        </div>
